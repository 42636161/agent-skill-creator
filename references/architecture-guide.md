# Architecture Guide — Complex Skills & Suites

**Load condition**: Only when the skill is a complex suite (3+ independent workflows)
or a refactoring of a growing skill. For simple skills, the decision framework
and directory structure are in `references/pipeline-phases.md` §Phase 3.
Do NOT load this file for simple skills.
